...
private:
	...
	std::unique_ptr<Missile> 	m_Missile0 = nullptr;
	std::unique_ptr<Missile> 	m_Missile1 = nullptr;
	std::unique_ptr<Ball> 		m_Ball = nullptr;
	std::unique_ptr<Playfield> 	m_Playfield = nullptr;
...
public:
	...
	void CalcBuffer()
	{
		...
		switch (m_Size) {
			// One copy
			case 0:memcpy(&m_SpriteBuffer[0], &m_Sprite, sizeof m_Sprite);
				break;

				// Two copies - close
			case 1:memcpy(&m_SpriteBuffer[0], &m_Sprite, sizeof m_Sprite);
				memcpy(&m_SpriteBuffer[2], &m_Sprite, sizeof m_Sprite);
				break;

				// Two copies - med
			case 2:memcpy(&m_SpriteBuffer[0], &m_Sprite, sizeof m_Sprite);
				memcpy(&m_SpriteBuffer[4], &m_Sprite, sizeof m_Sprite);
				break;

				// Three copies - close
			case 3:memcpy(&m_SpriteBuffer[0], &m_Sprite, sizeof m_Sprite);
				memcpy(&m_SpriteBuffer[2], &m_Sprite, sizeof m_Sprite);
				memcpy(&m_SpriteBuffer[4], &m_Sprite, sizeof m_Sprite);
				break;

				// two copies - wide
			case 4:memcpy(&m_SpriteBuffer[0], &m_Sprite, sizeof m_Sprite);
			...
			case 5:
				...
				// 3 copies med
			case 6:memcpy(&m_SpriteBuffer[0], &m_Sprite, sizeof m_Sprite);
				memcpy(&m_SpriteBuffer[4], &m_Sprite, sizeof m_Sprite);
				memcpy(&m_SpriteBuffer[8], &m_Sprite, sizeof m_Sprite);
				break;
...
{
public:
	Playfield(std::shared_ptr<Player> Player0, std::shared_ptr<Player> Player1)
	{
		m_Player0 = Player0;
		m_Player1 = Player1;
		m_PF0 = 0x00;
...
private:
	std::shared_ptr<Player> m_Player0;
